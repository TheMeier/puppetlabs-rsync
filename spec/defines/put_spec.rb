...
describe 'rsync::put', type: :define do
  ...
  describe 'when setting a user but not a keyfile' do
    ...
    it {
      is_expected.to contain_exec('rsync foobar')
        .with('command' => 'rsync -q -a -e \'ssh -i /home/mr_baz/.ssh/id_rsa -l mr_baz\' example.com mr_baz@foobar',
  ...
  describe 'when setting a user and a keyfile' do
    ...
    it {
      is_expected.to contain_exec('rsync foobar').with('command' => 'rsync -q -a -e \'ssh -i /path/to/keyfile -l mr_baz\' example.com mr_baz@foobar',
